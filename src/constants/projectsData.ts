...
const projectData: ProjectData[] = [
    ...
    },
    {
        ...
        technicalStack: ['Python', 'Numpy', 'Keras', 'Pandas', 'CV2', 'Jupyter Notebook'],
    ...
    },
    {
        ...
        technicalStack: ['Python', 'Django', 'Numpy', 'Matplotlib', 'Tensorflow', 'Keras', 'Jupyter Notebook', 'HTML'],
    ...
    },
    {
        ...
        technicalStack: ['Python', 'Flask', 'Numpy', 'Pandas', 'Matplotlib', 'Sklearn', 'Jupyter Notebook', 'XGBoost', 'HTML', 'Docker', 'ELK Stack'],
    ...
    },
    {
        ...
        technicalStack: ['Python', 'Jupyter Notebook', 'HTML', 'CSS', 'JavaScript', 'Sklearn'],
