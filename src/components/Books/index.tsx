...
const BookModel = (props: JSX.IntrinsicElements['group']) => {
    ...
    return (
        <group {...props} dispose={null}>
            ...
            <directionalLight intensity={1024.5} color="#f3bc85" position={[0, 6.38, 0]} rotation={[-2.352, 0.63, 2.606]} target={nodes.Sun.target}>
            ...
            <mesh geometry={nodes['Ground-Mate'].geometry} material={materials['Ground-Mate-Color']} scale={[7, 1, 7]} />
